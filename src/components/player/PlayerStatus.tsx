  ...
  return (
    <div className="flex items-center gap-4 text-sm">
      ...
      <div className="flex items-center gap-2">
        <span className="app-text-muted">File:</span>
        <span className="font-medium truncate max-w-xs">{player.filename || "No file loaded"}</span>
      </div>

      {/* Position / Duration */}
      {player.position !== null && player.duration !== null && (
        <div className="flex items-center gap-2">
          <span className="app-text-muted">Time:</span>
